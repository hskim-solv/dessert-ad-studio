...
Latest local regression snapshot: `273 passed`.
...
- Extend the M8/M10 Agentic RAG first gates from local
  graph/tool-suite/SSE/WebSocket/SQLite/replay/trace/reviewer-approval proof to
  post-approval worker resume, production stream replay retention policy,
