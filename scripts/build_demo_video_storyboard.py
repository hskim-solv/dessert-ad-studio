...
def build_demo_video_storyboard_summary(*, evidence_date: str) -> dict[str, Any]:
    ...
    return {
        ...
        "coverage": {
            ...
            "pending_decision_register": _contains_artifact(
                referenced_artifacts, "agentic-rag-decision-register.md"
            ),
        },
        "privacy_boundary": {
    ...
    return (
        ...
        StoryboardShot(
            ...
            visual=(
                ...
                "pending decision register, and final outcome pending rows."
            ),
            narration=(
                ...
                "The decision register shows which remaining items require "
                "approval before any production claim. "
