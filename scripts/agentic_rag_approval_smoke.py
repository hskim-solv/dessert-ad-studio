...
os.environ.setdefault("OUTPUT_DIR", "outputs/agentic-rag-approval-smoke")
os.environ.setdefault(
    "GENERATION_LOG_PATH",
    "logs/agentic-rag-approval-smoke-generations.jsonl",
)
os.environ.setdefault(
    "AGENTIC_RAG_CHECKPOINT_DB",
    "outputs/agentic-rag-checkpoints/agentic-rag-approval-smoke.sqlite",
)
...
DEFAULT_OUTPUT_PATH = Path("docs/evidence/agentic-rag-approval-summary.json")


def build_agentic_rag_approval_summary(*, evidence_date: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "stream_protocol": events[0]["data"]["stream_protocol"],
            ...
            "reviewer_id_sha256_present": approval["reviewer_id_sha256"] is not None,
            "comment_sha256_present": approval["comment_sha256"] is not None,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build local FastAPI HITL approval evidence for Agentic RAG.",
        allow_abbrev=False,
    )
    ...
    summary = build_agentic_rag_approval_summary(evidence_date=args.date)
